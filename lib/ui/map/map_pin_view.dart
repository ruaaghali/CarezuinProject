...
import 'package:latlng/latlng.dart' as thelatlang;



class MapPinView extends StatefulWidget {
  const MapPinView({@required this.flag, @required this.maplat, @required this.maplng});
                ...
                InkWell(
                  ...
                  onTap: () {
                    Navigator.pop(context,
                        MapPinCallBackHolder(address: address, latLng: thelatlang.LatLng(latlng.latitude,latlng.longitude)));
                  },
                ),
                const SizedBox(
