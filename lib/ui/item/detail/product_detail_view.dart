                                    ...
                                    if (provider.itemDetail.data.addedUserId ==
                                      ...
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: <Widget>[
                                            if (provider.itemDetail.data.paidStatus ==
                                                PsConst.ADSPROGRESS)
                                              if (provider.itemDetail.data.addedUserId ==
                                              ...
                                              else if (provider.itemDetail.data.paidStatus ==
                                                      PsConst.ADS_REJECT &&
                                                  provider.itemDetail.data.addedUserId ==
                                                      provider.psValueHolder
                                                          .loginUserId)
                                              ...
                                              ] else if (provider.itemDetail.data.paidStatus == PsConst.ADSNOTYETSTART) ...<Widget>[
                                                Container(
                                                  decoration: BoxDecoration(
                                                      borderRadius:
                                                          BorderRadius.circular(
...
class __HeaderBoxWidgetState extends State<_HeaderBoxWidget> {
  ...
  void didChangeDependencies() async {
    ...
    for (int r = 0; r < list.length; r++) {
      if (list[r]['id'] == widget.itemDetail.itemDetail.data.title) {
      ...
      return Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            urlVideo == '1' && list != null && list.length > 0
                ? Container(
                ...
                : urlVideo == '0'
                    ...
                    : Padding(
                        ...
                        child: Text("Video For this Item Not Exists"),
                      ),
            Row(
