...
import 'package:flutteradmotors/ui/common/advertisement/add_extra_information_screen.dart';
import 'package:flutteradmotors/ui/common/advertisement/add_media_screen.dart';
import 'package:flutteradmotors/ui/common/advertisement/add_extra_information2_screen.dart';
import 'package:flutteradmotors/ui/common/advertisement/add_advertisment_final_screen.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case '${RoutePaths.add_media}':
      return MaterialPageRoute<dynamic>(
          builder: (BuildContext context) => AddMediaScreen());
    case '${RoutePaths.addAdvertisment_Final_Screen}':
      return MaterialPageRoute<dynamic>(
          builder: (BuildContext context) => AddAdvertismentFinalScreen());
    ...
    case '${RoutePaths.itemEntryView}':
      return MaterialPageRoute<dynamic>(builder: (BuildContext context) {
        final Object args = settings.arguments;
        final Arguments args2 = args ?? Arguments;
        return ItemEntryView(
          animationController: args2.animationController,
          flag: args2.flag,
          item: args2.item,
        );
      });
    ...
    case '${RoutePaths.extra_info}':
      return MaterialPageRoute<dynamic>(builder: (BuildContext context) {
        //final Object args = settings.arguments;
        //final String transmissionName = args ?? String;
        return AddExtraInformationScreen();
      });
    case '${RoutePaths.extra_info2}':
      return MaterialPageRoute<dynamic>(builder: (BuildContext context) {
        //final Object args = settings.arguments;
        //final String transmissionName = args ?? String;
        return AddExtraInformationScreen2();
      });
